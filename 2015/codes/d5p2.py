...
from commons.NiceString import NiceString

with open('2015/inputs/d5.txt', 'r') as file:
    n = 0

    for input in file:
        mNiceString = NiceString(input.strip())
        try:
            mNiceString.validate2()
            n += 1
        except Exception:
            pass

    print('Total nice strings: {}'.format(n))
